...
<template>
  ...
  >
    ...
    <p class="mb-3 text-slate-600 dark:text-slate-300">
      The <span class="text-amber-600 dark:text-amber-400">amber cell</span> is the one being
      computed right now. The <span class="text-sky-600 dark:text-sky-400">blue cells</span> are the
      ones its recurrence read, and an arrow runs from each of them into it. Where the recurrence
      has to <em>choose</em> — take the item or skip it, insert or delete or substitute — the
      winning branch is drawn
      <span class="text-rose-600 dark:text-rose-400">thicker and in red</span>, and the others stay
      thin. That red arrow is the decision the traceback will later follow back.
    </p>
    <p class="mb-3 text-slate-600 dark:text-slate-300">
    ...
    <p class="mb-3 text-slate-600 dark:text-slate-300">
      ...
      <span class="text-emerald-600 dark:text-emerald-400">green path</span> is the second pass that
