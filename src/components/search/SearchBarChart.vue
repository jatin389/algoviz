  ...
  <div class="av-card flex h-full flex-col p-4 sm:p-5">
    <div class="mb-3 flex flex-wrap items-center gap-x-4 gap-y-2">
      ...
      <div class="flex flex-wrap items-center gap-3 text-xs text-slate-500 dark:text-slate-400">
        <span class="flex items-center gap-1.5"><i class="h-3 w-3 rounded-sm bg-indigo-500/80 dark:bg-indigo-400/80" />Default</span>
        <span class="flex items-center gap-1.5"><i class="h-3 w-3 rounded-sm bg-indigo-300 dark:bg-indigo-600" />Active range</span>
        <span class="flex items-center gap-1.5"><i class="h-3 w-3 rounded-sm bg-amber-400" />Checking</span>
        <span class="flex items-center gap-1.5"><i class="h-3 w-3 rounded-sm bg-emerald-500" />Found</span>
      </div>
    </div>
