  ...
  <div class="av-card p-4 sm:p-5">
    ...
    <div class="mt-5 grid grid-cols-2 gap-2">
      ...
      <button
        type="button"
        :disabled="!canEdit"
        class="col-span-2 flex items-center justify-center gap-2 rounded-xl bg-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-700 transition-all hover:bg-slate-300 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-slate-600"
